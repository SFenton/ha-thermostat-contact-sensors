...
TEST_TEMPERATURE_SENSOR = TEST_TEMP_SENSOR_1
TEST_HUMIDITY_SENSOR = TEST_OTHER_SENSOR_1
TEST_ACTIVITY_ENTITY = "input_boolean.stephen_pc_power"
TEST_WEATHER = "weather.test_forecast"
...
async def setup_test_entities(hass: HomeAssistant) -> None:
    ...
    hass.states.async_set(
        ...
        STATE_OFF,
        {"friendly_name": "Stephen PC Power"},
    )
    hass.states.async_set(
        TEST_WEATHER,
        "sunny",
...
def get_test_config_options() -> dict[str, Any]:
    ...
    return {
        ...
        CONF_VACATION_MODE_ENTITY: DEFAULT_VACATION_MODE_ENTITY,
    }
